...
public class MapActivity extends BaseActivity {
        ...
        mapView.setOnMapClickListener(new OnMapClickListener() {
            ...
            public void onMapClick(LatLng loc) {
                if (isAddNewLocationClicked) {
                    ...
                    routeItem.getAddress().setLatitude(locMarked.latitude);
                    routeItem.getAddress().setLongitude(locMarked.longitude);
    ...
    private void handleStartingPosition() {
        ...
        if (location == null) if (location2 == null) {
        } else {
